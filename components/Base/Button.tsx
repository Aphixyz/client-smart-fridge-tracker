...
const BaseButton = ({
  ...
  const baseStyles =
    "inline-flex items-center justify-center gap-2 font-kanit transition-all duration-200 active:scale-95 select-none focus:outline-none focus:ring-2 focus:ring-offset-2";
  ...
  const variants = {
    ...
    emerald:
      "bg-emerald-500 text-white hover:bg-emerald-700 shadow-sm focus:ring-emerald-500",
    cancel: "bg-[#CDEAFF] text-black shadow-sm focus:ring-[#2ECC71]",
    trash:
      "absolute top-3 right-3 w-10 h-10 !p-0 flex items-center justify-center bg-gray-200 rounded-full hover:bg-red-100 transition-colors",
  };
