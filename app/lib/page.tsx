...
import { validateUserRequest } from "@/validator/User";
...
export default function MyPage() {
      ...
      accessor: (item) => (
        <div className="flex flex-col">
          <span className="text-slate-700">
            {DateUtils.format(item.createdAt, "short")}
          </span>
          <span className="text-[10px] text-slate-400">
            {DateUtils.format(item.createdAt, "relative")}
          </span>
        </div>
      ),
    },
  ...
  const handleFormUserCreateChange = (
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <BaseButton shape="full" variant="primary" isLoading={true}>
          กำลังบันทึก...
        </BaseButton>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <BaseCard>
          ...
          <BaseInput
            ...
            onChange={(e) =>
              handleFormUserCreateChange("email", e.target.value)
            }
          ...
          <BaseInput
            ...
            onChange={(e) =>
              handleFormUserCreateChange("status", e.target.value)
            }
        ...
        <BaseModal
          ...
          footer={
            <>
              ...
              <BaseButton shape="full" onClick={handleSave}>
                บันทึกข้อมูล
              </BaseButton>
            </>
          }
        >
          ...
          <form className="space-y-4 font-kanit">
            ...
            <BaseDropdown
              ...
              value={formData.role}
              onChange={(val) =>
                setFormData({ ...formData, role: val.toString() })
              }
